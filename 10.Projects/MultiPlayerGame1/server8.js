...
const { wss, port, clients, announcement } = require('./refactor8/websocket8');
const { logger } = require('./refactor8/logger8.js');
const { defaultGameRoom } = require('./refactor8/gamemanager8');
...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'game8.html'));
});
