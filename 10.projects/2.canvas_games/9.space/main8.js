...
let backgroundImage, spaceshipImage, bulletImage, bombImage, enemyImage, gameOverImage;
let gameOver = false;
let score = 0;
let stage = 1;
...
class Bomb {
    ...
    update() {
        ...
        if (this.m >= 50) {
            ...
            createBullet(this.x, this.y - 5);
            createBullet(this.x - 20, this.y);
            createBullet(this.x + 20, this.y);
            createBullet(this.x - 40, this.y + 5);
            createBullet(this.x + 40, this.y + 5);
